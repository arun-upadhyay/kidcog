...
export async function generateRound(age: number, trait: TraitKey, count: number): Promise<GeneratedQuestion[]> {
...
Every question must be self-contained. Use short everyday words, especially under age 8. Include any pattern or details to notice in the prompt itself; never refer to a missing picture. Avoid school-specific knowledge, personal details, sensitive disclosures, scary situations, or adult topics. Repeats from earlier rounds are allowed; keep questions within this round distinct.
